...
const studyQuestionRoutes = require('./routes/studyQuestionRoutes');
const studyAnswerRoutes = require('./routes/studyAnswerRoutes');
...
app.use('/api/manage-ai-generated-questions', studyQuestionRoutes);
app.use('/api/manage-user-given-answers', studyAnswerRoutes);
